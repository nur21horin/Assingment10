    ...
    <section className="py-16 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <span className="text-sm font-semibold bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 px-4 py-1 rounded-full">
            Featured Foods
          </span>
            ...
            >
              ...
              <div className="p-5 pt-0">
                <button
                  ...
                  className="w-full bg-blue-600 dark:bg-blue-700 text-white hover:bg-blue-700 dark:hover:bg-blue-800 py-2 rounded-md transition"
                >
                  View Details
                </button>
              </div>
        ...
        <div className="text-center mt-12">
          <Link to="/availablefoods">
            <button className="border border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 px-6 py-2 rounded-md hover:bg-blue-600 dark:hover:bg-blue-400 hover:text-white transition">
